...
def build_dataloaders(cfg: CFG):
    ...
    tokenized_train_dataset = shuffled_train_files.map(
        tokenize, 
        batched = True,
        num_proc = 16, 
        remove_columns = [cfg.select_input_string],
    ...
    tokenized_eval_dataset = shuffled_eval_files.map(
        tokenize, 
        batched = True,
        num_proc = 16, 
        remove_columns = [cfg.select_input_string],
